...
.ORIG       x3000					  ;specifies where the program will be stored	
            LD    R1,INPUT            ; R1 contains input number
            LD    R2,INPUT1           ; R2 contains -1
